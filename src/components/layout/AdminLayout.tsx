...
const navItems: NavItem[] = [
    ...
    { path: "/admin/auto-order", label: <span style={{ display: 'flex', flexDirection: 'column' }}><span>Auto Order</span><span className="text-[10px] opacity-75 leading-none mt-0.5">(only for myself)</span></span>, icon: Zap, color: "#ea580c" },
    ...
    { path: "/admin/balance-requests", label: "Balance", icon: DollarSign, color: "#f59e0b" },
