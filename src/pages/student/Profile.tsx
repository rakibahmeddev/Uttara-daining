...
export default function Profile() {
    ...
    return (
        <div className="max-w-2xl mx-auto" style={{ width: '100%', margin: '24px auto 48px', padding: '0 16px' }}>
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden" >
                {/* Header */}
                <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white" style={{ padding: '28px 24px' }}>
